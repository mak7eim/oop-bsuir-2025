...
import (
	...
	"lab3/internal/application"
	"lab3/internal/domain"
	"lab3/internal/infrastructure"
)
...
func main() {
	...
	clientMsg := infrastructure.NewSMTPMailer("smtp.google.com")
	...
	processor := application.NewOrderProcessor(db, cache, clientMsg, managerMsg)
